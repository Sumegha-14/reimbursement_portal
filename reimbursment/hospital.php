                    ...
                    <!-- Header -->
                        <div id="header">
                            ...
                            <!-- Inner -->
                                <div class="inner">
                                    <header>
                                        <h1><a href="index.html" id="logo">Predict it here.</a></h1>
                                    </header>
                                </div>
                            ...
                            <div class="container">
                                <div class="row gtr-200">
                                    <div class="col-4 col-12-mobile" id="sidebar">
                                       ...
                                       <!-- <section>
                                            <header>
                                               <h3><a href="#">Predict your disease here:</a></h3>
                                            </header>
                                            <p>
                                                Mention your symptoms and we shall try and predict your diease.
                                    ...
                                    <div class="col-8 col-12-mobile imp-mobile" id="content">
                                        <article id="main">
                                            <header>
                                                <h2><a href="#">Predict Disease</a></h2>
                                                <p>
                                                    Know your disease in a minute </p>
                                            </header>
